...
path =r'D:\python\pythonDemo\cifarTest\tf\work\trash_detection\imgs\test\\' #'testing_data2\\'

classify_label = ['trashCan','rubbishDump','other']
meta_graph_path=r'D:\python\pythonDemo\cifarTest\tf\work\trash_detection\model\classify\trash.ckpt-962.meta'
model_data_path=r'D:\python\pythonDemo\cifarTest\tf\work\trash_detection\model\classify\trash.ckpt-962'
...
y_test_images = np.zeros((len(x_batch), 3)) 
