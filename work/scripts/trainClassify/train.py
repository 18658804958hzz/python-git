...
batch_size = 32
classes = ['trashCan','rubbishDump','other']
num_classes = len(classes)
validation_size = 0.2 # 20% of the data will automatically be used for validation
img_size = 128
num_channels = 3
train_path=r'D:\python\pythonDemo\cifarTest\tf\work\trash_detection\imgs\trainImgs\\'
...
def train(num_iteration):
    ...
    for i in range(total_iterations,total_iterations + num_iteration):
        ...
        if i % int(display_step) == 0: 
            ...
            # print(epoch, val_loss,i)
            saver.save(session, r'D:\python\pythonDemo\cifarTest\tf\work\trash_detection\model\classify\trash.ckpt',global_step=i)
